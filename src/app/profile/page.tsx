...
import { api } from "../../../reptracker-AI/convex/_generated/api";
import { useState } from "react";
import ProfileHeader from "@/components/ProfileHeader";
import NoFitnessPlan from "@/components/NoFitnessPlan";
import CornerElements from "@/components/ConerElements";
import { Button } from "@/components/ui/button";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import { AppleIcon, CalculatorIcon, DumbbellIcon } from "lucide-react";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
const ProfilePage = () => {
    ...
    const allPlans = useQuery(api.plans.userUserPlans, {userId});
        ...
        return (
            <section className="relative z-10 pt-12 pb-32 flex-grow container mx-auto px-4">
                ...
                <div className="flex items-center justify-center py-12">
                    <div className="text-muted-foreground">Loading your fitness plans...</div>
                </div>
            </section>
        );
    }
                                ...
                                <div className="relative backdrop-blur-sm border border-border rounded-lg p-6">
                                    ...
                                    <div className="flex items-center gap-2 mb-4">
                                        ...
                                        <h3 className="text-lg font-bold">
                                            PLAN: <span>{currentPlan.name}</span>
                                        </h3>
                                    </div>
